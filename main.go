...
import (
	...
	infrastructurev1alpha1 "github.com/pricemgp24/cluster-api-provider-docker/api/v1alpha1"
	"github.com/pricemgp24/cluster-api-provider-docker/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "91e1086a.cluster.x-k8s.io",
